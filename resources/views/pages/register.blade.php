...
<body class="bg-slate-100 overflow-y-hidden">
  <header class="w-full py-5 px-5">
    <div class="float-end flex flex-row gap-4 items-center">
      ...
      <a href="/login" class="bg-mainGreen h-min w-20 justify-center py-px text-sm rounded-lg flex font-thin text-white items-center">Login</a>
            ...
            <div class="w-full bg-white rounded-2xl max-w-md">
                <div class="p-10 space-y-3">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/register" method="post">
                        ...
                        <div>
                            <label for="password" class="ml-4 block mb-1 text-sm font-medium text-gray-900">Password</label>
                        ...
                        <input type="submit" value="Create an account" class="w-full text-white bg-mainGreen font-bold rounded-full text-sm px-5 py-2.5 text-center">
