        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
            <div class="w-full bg-white-1 rounded-2xl max-w-md">
                <div class="p-10 space-y-3">
                    ...
                    <form class="space-y-4" action="/setup" method="post">
                        @csrf 
                        <div class="m-auto flex w-24 h-24 rounded-full overflow-hidden font-bold text-center justify-center items-center bg-gray-200">
                          <img src="{{ asset('assets/default_avatar.png') }}" class="w-full h-full" alt="">
                        </div>
                        <div>
                            <label for="name" class="mt-6 ml-4 block mb-1 text-sm font-medium text-gray-900">Name</label>
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-primary-600 focus:border-primary-600 block w-full py-2.5 px-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Set your name" required="">
                        </div>
                        <div class="relative">
                            ...
                            <input type="text" name="username" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-primary-600 focus:border-primary-600 block w-full py-2.5 pl-10 pr-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Set your username" required="">
                        </div>
