        ...
        <div class="mt-5 flex flex-row justify-between items-center">
            <div class="flex flex-row gap-3">
                <div class="w-12 h-12 rounded-full flex justify-center items-center overflow-hidden">
                    <img src="{{ $report->user->avatar == null ? asset('assets/default_avatar.png') : Storage::url($report->user->avatar) }}"
            ...
            <div>
                <h1 class="text-sm text-gray-400 text-end"><img src="{{ asset('assets/calendar.svg') }}" class="inline mr-2"
                        alt="">{{ Carbon::parse($report->date)->isoFormat('dddd, DD MMMM YYYY') }}</h1>
