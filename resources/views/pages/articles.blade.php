...
<div class="relative w-full h-64 overflow-hidden rounded-lg shadow-lg">
    ...
    <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center">
       <div class="text-left text-white pl-10">
          ...
          <span class="text-md text-gray-300 font-bold">1 minutes ago</span>
 ...
 <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="w-auto bg-white mt-4 rounded-lg shadow">
       ...
       <div class="pb-5 pt-3 px-5">
          ...
          <p class="mb-3 font-normal text-sm text-gray-700 dark:text-gray-400">{{ $article->text }} <a target="_blank" href="{{ $article->link }}" class="text-mainGreen">read more</a></p>
       </div>
    </div>        
    @endforeach      
