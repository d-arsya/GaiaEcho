<nav class="fixed top-0 z-10 bg-white w-full">
   <div class="flex bg-red justify-between py-4 px-8">
    ...
    <form action="/post/search" method="get" class="relative w-2/5 items-center hidden md:flex">
        <input name="q" type="text" id="search-navbar" class="block w-full p-2 ps-5 pe-10 text-sm text-gray-900 rounded-full bg-gray-200 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari...">
